  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index.html">
        ...
        <h4>2- Qual a finalidade da sua ideia ?</h4>
        <form>
          <input class="form-control" type="checkbox" name="diminui" value="20">Lucrar somente
          <input class="form-control" type="checkbox" name="diminui" value="2">Promover o bem-estar social
          <input class="form-control" type="checkbox" name="diminui" value="2">Contribuir para entidades de auxilio psicosocial
          <input class="form-control" type="checkbox" name="diminui" value="2">Gerar emprego
